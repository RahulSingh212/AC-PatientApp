...
class _CalorieState extends State<Calorie> {
    ...
    return Container(
        ...
        child: Column(
          ...
          children: [
            ...
            Text(
              isLangEnglish ? "The recommended daily calorie intake is 2,000 calories a day for women and 2,500 for men" : 
                              ...
                              SizedBox(
                                ...
                                child: TextField(
                                  ...
                                  decoration: InputDecoration(
                                    hintText: isLangEnglish ? "Calorie\nIntake " : "ऊष्मांक ग्रहण",
  ...
  Widget build(BuildContext context) {
    Cal_list = Provider.of<PatientHealthAndWellNessDetails>(context, listen: false).getCalorieLevelList();
